...
(() => {
  ...
  D.ind.forEach(it => {
    ...
    b.addEventListener('click', () => openModal({
      ...
      rows: [['คำอธิบาย', it.desc], ['ระดับที่คาดหวัง', 'ริเริ่ม พัฒนา (Originate & Improve) — ริเริ่ม คิดค้น พัฒนา หรือปรับปรุงการจัดการเรียนรู้ขึ้นใหม่ให้เหมาะกับบริบทและความแตกต่างของผู้เรียน จนเกิดผลต่อคุณภาพผู้เรียนและขยายผลสู่เพื่อนครูได้'], ['การปฏิบัติของข้าพเจ้า', it.body]], pics: it.pics
    }));
    it2.appendChild(b);
  });
